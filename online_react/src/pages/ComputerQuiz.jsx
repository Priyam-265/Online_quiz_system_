...
const ComputerScienceQuiz = () => {
    ...
    const fetchQuestions = async () => {
        try {
            ...
            const loadedQuestions = data.results.map((apiQuestion, index) => {
                        ...
                        <div className={`text-center w-full transition-all duration-300 ${gameState.started ? 'px-8 py-4' : 'px-16 py-8'}`}>
                            ...
                            {!gameState.started && (
                                <div ref={introContentRef}>
                                    ...
                                    <button
                                        ref={introButtonRef}
                                        className="border-0 px-7 py-3 rounded text-lg cursor-pointer font-medium shadow-lg mt-6 disabled:opacity-60 disabled:cursor-not-allowed"
                                        style={{
                                    ...
                                    {loading && (
                                        <div className="font-medium mt-3" style={{ color: 'var(--accent-color)' }}>
                                            Loading questions...
                                        </div>
                                    )}
                                    {error && (
                                        <div className="font-medium mt-3" style={{ color: '#ff6161' }}>
                                            {error}
                                        </div>
                                    )}
                                </div>
                        ...
                        <div className="overflow-auto p-10 flex-grow transition-all duration-300" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                            {!gameState.finished && currentQuestion && (
                                <div className="flex flex-col h-full">
                                            ...
                                            {currentQuestion.answers.map((answer, index) => (
                                                <li
                                                    ...
                                                    <label
                                                        ...
                                                        className="question-answer flex p-3 text-sm rounded overflow-hidden items-center border-2 cursor-pointer transition-all duration-300 hover:opacity-80"
                                                        style={{
                                    ...
                                    <button
                                        className="px-7 py-3 rounded mt-5 text-base cursor-pointer font-medium transition-colors hover:opacity-80"
                                        style={{
                                            backgroundColor: 'var(--accent-color)',
                                            color: 'var(--text-primary)',
                                            border: 'none'
